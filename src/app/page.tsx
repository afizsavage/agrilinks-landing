...
function CaseStudies({
  ...
  return (
    <>
      ...
      >
        <p>
          Depending on the digital equipment and digital aptitudes, users can
          access marketplace information and contact each other via USSD and
          SMS or through the online marketplace
        </p>
      </SectionIntro>
